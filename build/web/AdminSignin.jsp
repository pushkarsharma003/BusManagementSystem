<%-- 
    ...
    Created on : Apr 2, 2019, 5:47:21 PM
  ...
  <body>
    <div class="signin">
      <div class="form">
          ...
          <p class="h">Sign in</p>
        <form action="AdminSignin" name="signinform" onsubmit="return validateform()" method="post">
        ...
        <% 
            ...
            Object logf=hts.getAttribute("AdminLoginFail");
            if(logf!=null)
            {
                out.println("*Login failed");
                out.println("<br>");
                hts.removeAttribute("AdminLoginFail");
            }
        %>
          </p>
          <br>
          <a href="UserSignin.jsp" class="Ad" title="Sign in as User">No, I am a User</a><br><br>
